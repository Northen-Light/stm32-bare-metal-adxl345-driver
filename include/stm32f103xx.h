...
#define GPIOB_CRL_PIN_6_CONFIG_MASK     (0xFU << 24U)  
#define GPIOB_CRL_PIN_7_CONFIG_MASK     (0xFU << 28U)  
#define GPIOB_CRL_PIN_6_CONFIG_VALUE    (0xFU << 24U)  
#define GPIOB_CRL_PIN_7_CONFIG_VALUE    (0xFU << 28U)  